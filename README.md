...
- one of the `/res/drawable` directories for your icon pack's icons themselves (see the section below explaining how drawables are organized by their sizes to know which is the appropriate directory)
